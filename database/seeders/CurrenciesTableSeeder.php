...
class CurrenciesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Currency::create(["country" => "Algerie", "currency" => "Algerian dinar", "code" => "DZD", "symbol" => "د.ج", "thousand_separator" => " ", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ]);

        Currency::create([ "country" => "United Arab Emirates", "currency" => "United Arab Emirates dirham", "code" => "AED", "symbol" => "د.إ",
        "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ]);
    }
}
