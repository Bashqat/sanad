	...
	<div class="modal-body invite-user-sec">
		...
		<nav>
			<div class="nav nav-tabs" id="nav-tab" role="tablist">
				...
				<a class="nav-item nav-link role" id="employee-tab" role_attr="employee" data-toggle="tab" href="" role="tab" aria-controls="employee" aria-selected="false">Employee<div class="role-select-employee role-select" style="display:none"><i class="fa fa-check" aria-hidden="true"></i></div></a>
