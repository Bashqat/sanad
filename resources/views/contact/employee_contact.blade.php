<div class="tab-pane active" id="settings">
  ...
  ?>
    ...
    @endif
      ...
      @endif
      <a href="javascript:void(0)" class="float-right email_only" data-count="{{(isset($contact[0]->email) && !empty($contact[0]->email))?count($contact[0]->email)-1:0}}">Add Another Email</a>
      <br>
      <br>
...
@if(isset($contact[0]->address) && !empty($contact[0]->address) )
  @foreach($contact[0]->address as $key=>$address)
    ...
    <div class="form-group row address-contact-row">
      <label for="address" class="col-lg-12 col-md-12 col-sm-12 col-form-label">Employment Information
    </div>
    ...
    <div class="form-group row ">
      ...
      <div class="form-group row address-contact-row">
        <label for="address" class="col-lg-12 col-md-12 col-sm-12 col-form-label">Personal Information
      </div><br>
      <div class="form-group row ">
        <label for="email" class="col-lg-3 col-md-3 col-sm-4 col-form-label">Gender </label>
        <div class="col-lg-9 col-md-9 col-sm-8 contact-address-fields">

          <select name="contact[personal_info][0][gender]" class="form-control select2  select-input-field m-0" style="width: 100%;">
        ...
        <div class="form-group row ">
          <label for="email" class="col-lg-3 col-md-3 col-sm-4 col-form-label">Blood Type </label>
          <div class="col-lg-9 col-md-9 col-sm-8 contact-address-fields">
            <select name="contact[personal_info][0][blood_group]" class="form-control select2  select-input-field m-0" style="width: 100%;">
              <option value="">Select</option>
          ...
          <div class="form-group row ">
            <label for="email" class="col-lg-3 col-md-3 col-sm-4 col-form-label">Martial Status </label>
            <div class="col-lg-9 col-md-9 col-sm-8 contact-address-fields">
              <select name="contact[personal_info][0][martial_status]" class="form-control select2  select-input-field m-0" style="width: 100%;">
                <option value="">Select</option>
            ...
            <div class="form-group row contact-row contact-dof-row">
              <label for="email" class="col-lg-3 col-md-3 col-sm-4 col-form-label">Place / Date of birth</label>
                  <div class="col-lg-9 col-md-9 col-sm-8">
                    <div class="date-contact-fields">
                      <div class="contact-address-fields  mb-lg-0 mb-3">
                        ...
                        <!-- <label for="email" class="col-lg-1 col-md-1 col-sm-4 col-form-label">Dob</label> -->
                          <div class="contact-address-fields d-flex align-items-sm-start align-items-center">
                          <label for="email" class="col-form-label pr-2">Dob</label>
            ...
            <div class="form-group row ">
              <label for="email" class="col-lg-3 col-md-3 col-sm-4 col-form-label">Nationality</label>
              <div class="col-lg-9 col-md-9 col-sm-8 contact-address-fields">
                  <select name="contact[personal_info][0][nationality]" class="form-control select2 select-input-field m-0" id="countrySelect">
                    <option class="mmmm" value="">Select Country</option>
                    @foreach ($countries as $value => $option )
  ...
  @if(isset($contact[0]->emergency_contact) && !empty($contact[0]->emergency_contact))
    @foreach($contact[0]->emergency_contact as $key=>$emergency_contact)
        <div class="emergency-contact">
            <div class="form-group row address-contact-row">
              <label for="address" class="col-lg-12 col-md-12 col-sm-12 col-form-label">Emergency Contact Information ({{$key+1}})</label>
            </div>
            <div class="form-group row ">
          ...
          <div class="emergency-contact">
              <div class="form-group row address-contact-row">
                <label for="address" class="col-lg-12 col-md-12 col-sm-12 col-form-label">Emergency Contact Information</label>
              </div>
              <div class="form-group row ">
                <label for="email" class="col-lg-3 col-md-3 col-sm-4 col-form-label">Name </label>
                <div class="col-lg-9 col-md-9 col-sm-8 contact-address-fields">
          ...
          @endif
            <a href="javascript:void(0)" class="float-right emergency_contact" data-count="{{(isset($contact[0]->mobile) && !empty($contact[0]->mobile))?count($contact[0]->mobile)-1:0}}">Add Another contact</a>
            <br>
            <br>
            ...
            <div class="dependent-information">
                <div class="form-group row address-contact-row">
                  <label for="address" class="col-lg-12 col-md-12 col-sm-12 col-form-label">Dependent Information({{$key+1}})</label>
                </div>
                <div class="form-group row contact-row">
                ...
                <div class="form-group row contact-date-row">
            ...
            <div class="dependent-information">
                <div class="form-group row address-contact-row">
                  <label for="address" class="col-lg-12 col-md-12 col-sm-12 col-form-label">Dependent Information</label>
                </div>
                <div class="form-group row contact-row">
                    <label for="address" class="col-lg-3 col-md-3 col-sm-4 col-form-label"></label>
                  <div class="col-lg-9 col-md-9 col-sm-8">
                ...
                <div class="form-group row contact-row contact-date-row">
                  <label for="email" class="col-lg-3 col-md-3 col-sm-4 col-form-label">Government id </label>
                <div class="col-lg-9 col-md-9 col-sm-8">
                    <div class="date-contact-fields">
                  <div class="contact-address-fields mb-lg-0 mb-3">
            ...
            @endif
            <a href="javascript:void(0)" class="float-right dependent_info" data-count="{{(isset($contact[0]->mobile) && !empty($contact[0]->mobile))?count($contact[0]->mobile)-1:0}}">Add Another Dependent</a>
   <br>
   <br>
